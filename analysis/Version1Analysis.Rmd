...
```{r cars}
CWV_measurements <- read_excel("./BANDWIDTH_5Mbps/CWV_2.xlsx",)

folder_path <- "./BANDWIDTH_5Mbps/output3/"
...
CWV_measurements_wide = CWV_measurements %>% select(!Date) %>% pivot_wider(names_from = name, values_from = Value)
